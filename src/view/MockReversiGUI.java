 ...
 */
public class MockReversiGUI extends JFrame implements ReversiView {
  private final ReadOnlyReversiModel model;
  public final JButton[][] boardButtons;
  private int prevX = -1;
  private int prevY = -1;
   ...
   */
  public MockReversiGUI(ReadOnlyReversiModel model) {
    this.model = model;
  ...
  /**
   * The addListener method add relevant listeners.
   */
